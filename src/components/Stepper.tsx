...
const steps = [
  {
    ...
    description: `Add clusters and connect them`
  },
  {
    label: "Select the Number of Kafka Clusters",
    description: "Add clusters and connect them"
  },
  {
    label: "Choose Your Preferred Sync",
    description: `Add clusters and connect them`
  },
  {
    label: " Create Data Pipeline",
    description: `When finished designing your data pipeline, click "Create Pipeline" below to locally launch your containers.`
  }
];
