  ...
  return (
    <div id='overviewContainer'>
      ...
      <div className='flex flex-row justify-items-stretch'>
        ...
        <iframe src={`http:/${httpLink}/d-solo/5nhADrDWk/kafka-metrics?panelId=40&orgId=1&from=1657209420673&to=1657213020673&var-job=kafka&var-broker=All&var-topic=All&var-online_broker=3`} width="450" height="200"></iframe>
      </div>
    </div>
  )
}
